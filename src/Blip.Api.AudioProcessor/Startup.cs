using Blip.Api.AudioProcessor.Middleware;
...
namespace Blip.Api.AudioProcessor
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .Configure<AzureSettings>(Configuration)
                .AddSingleton(sp => sp.GetRequiredService<IOptions<AzureSettings>>().Value);
            ...
            // Setup transcription services
            services.AddTransient<IMediaDownloader, MediaDownloader>();
            services.AddTransient<IMediaConversor, MediaConversor>();
            services.AddTransient<ISpeechTranscriptor, AzureSpeechTranscriptor>();
            services.AddTransient<IAudioTranscriptor, AudioTranscriptor>();
